...
is batting" and "The bowler is bowling", respectively. Write a
program to create objects of both the
...
#Define the dervided cladss batsman
class Batsman (player):
  def play(self):
    print("The batsman is batting.")
#Define the dervided class bowler 
class Bowler (player):
  def play (self):
